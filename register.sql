...
INSERT INTO `admin` (`adminID`, `name`, `phone`, `email`, `password`, `location`) VALUES
...
ALTER TABLE `parents`
  ...
  ADD CONSTRAINT `parents_ibfk_2` FOREIGN KEY (`adminID`) REFERENCES `admin` (`adminID`) ON DELETE CASCADE;
...
ALTER TABLE `students`
  ...
  ADD CONSTRAINT `students_ibfk_2` FOREIGN KEY (`adminID`) REFERENCES `admin` (`adminID`) ON DELETE CASCADE;

--
-- Limiti per la tabella `teachers`
--
ALTER TABLE `teachers`
  ADD CONSTRAINT `teachers_ibfk_1` FOREIGN KEY (`adminID`) REFERENCES `admin` (`adminID`) ON DELETE CASCADE;
